...
class TeamLeavesServiceImplTest {
    ...
    void getDirectReportees_success() {
        ...
        when(employeeRepo.findByManager_Id(1L))
    ...
    void approveLeave_leaveNotFound() {
        ...
        when(leaveRequestRepo.findById(100L))
                .thenReturn(Optional.empty());

        ApiResponse response =
                service.approveLeave(1L, 100L, "Approved");
    ...
    void approveLeave_success() {
        ...
        verify(approvalRepo, times(1))
                .save(any(LeaveApproval.class));
    ...
    void rejectLeave_success() {
        ...
        ApiResponse response =
                service.rejectLeave(1L, 100L, "Not valid");
    ...
    void getTeamLeaveBalance_success() {
        ...
        when(employeeRepo.findByManager_Id(1L))
                .thenReturn(Collections.singletonList(employee));
        when(leaveBalanceRepo.findByEmployee_Id(2L))
                .thenReturn(Collections.emptyList());

        ApiResponse response =
                service.getTeamLeaveBalance(1L);
