...
public class PerformanceReviewServiceImpl implements PerformanceReviewService {
	...
	public ApiResponse submitManagerFeedback(Long managerId, PerformanceReviewDTO dto) {
		...
		if (dto.getManagerRating() < 1 || dto.getManagerRating() > 5) {
			...
			logger.warn("Invalid rating {} for review {}", dto.getManagerRating(), dto.getReviewId());
		...
		logger.info("Notification sent to employee {} for performance review", employee.getEmployeeId());
