...
public class LeaveController {
	...
	public LeaveController(LeaveRequestService leaveRequestService, LeaveBalanceService leaveBalanceService,
	...
	public ResponseEntity<ApiResponse> getHistory(@PathVariable Long employeeId) {

		ApiResponse response = leaveRequestService.getLeaveHistory(employeeId);

		return ResponseEntity.ok(response);
	}

	@GetMapping("/leave/balance/{employeeId}")
	public ResponseEntity<ApiResponse> getBalances(@PathVariable Long employeeId) {

		ApiResponse response = leaveBalanceService.getEmployeeBalances(employeeId);
